package at.jku.cp.rau.search.datastructures;
...
/**
 * This class implements a priority-queue with stable sorting. That means, it
 * remembers the order in which elements with the same key have been inserted,
 * and returns them again in that order.
 * 
 * @param <Key>
 * @param <Value>
 */
