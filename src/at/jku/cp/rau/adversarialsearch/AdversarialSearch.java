...
public interface AdversarialSearch<T extends Node<T>> {
     ...
     * associated with it.
     * 
     * The function returns a pair, namely the most beneficial state we want to
     * be in, given the current state and the evalFunction. Additionally we'll
     * return the value of the evalFunction that has led to this decision.
     * 
     * @param start
