...
public class TestMoves {
    ...
    public static Collection<Object[]> generateParams() {
        ...
        params.add(new Object[] { Arrays.asList("#####", "#...#", "#.p.#", "#...#", "#####"),
        ...
        params.add(new Object[] { Arrays.asList("###", "#p#", "###"), Arrays.asList(Move.STAY, Move.SPAWN) });

        params.add(new Object[] { Arrays.asList("#####", "#*pm#", "#####"),
                Arrays.asList(Move.STAY, Move.SPAWN, Move.RIGHT) });
        ...
        params.add(new Object[] { Arrays.asList("#####", "#mmm#", "#mpm#", "#mmm#", "#####"),
