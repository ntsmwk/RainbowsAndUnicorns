...
public class TestBoard
{
	...
	public void seedOnTopOfSeedTwoPlayers()
	{
		...
		assertFalse(a.executeMove(Move.LEFT)); // p1 cannot go right b/c of seed;
	}
	...
	public void whatsAt()
	{
		...
		assertEquals(a.at(new V(2, 1)).get(2), new Seed(new V(2, 1),
				Seed.DEFAULT_FUSE - 1, Seed.DEFAULT_RANGE));
