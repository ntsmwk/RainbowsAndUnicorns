...
public interface IBoard {
    /**
     * This method deep-copies only the active gameobjects: * EndCondition *
     * Markers * Clouds * Unicorns * Seeds * Rainbows
     * 
     * And copies only references to the passive ones: - Walls - Paths
     * 
    ...
    /**
     * This method gives us a List of possible moves for the current unicorn
     * 
    ...
    /**
     * This is the only method to change the state of the board, according to
     * the move specified.
     * 
     * @param move
