...
{
	/**
	 * This method deep-copies only the active gameobjects:
	 * * EndCondition
	 * * Markers
	 * * Clouds
	 * * Unicorns
	 ...
	 * * Rainbows
	 * 
	 * And copies only references to the passive ones:
	 * - Walls
	 * - Paths
	...
	/**
	 * This method gives us a List of possible moves for the
	 * current unicorn
